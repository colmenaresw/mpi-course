 ...
 */
double trapez_2n(float a, float b, float tn, int n)
{
...
int main(int argc, char* argv[]) {
   /* 
	...
	double tn = trapezoidal(my_boundaries[0], my_boundaries[1], n);
	...
	while(true)
	{
		...
		double t2n = trapez_2n(my_boundaries[0], my_boundaries[1], tn, 2 * n);
		/* local sub-integral */
